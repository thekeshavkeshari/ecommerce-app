    ...
    <>
        ...
        {/* <div className="grid grid-cols-3 gap-6 mt-4 md:grid-cols-6 ">
          <div>
            <div className="aspect-[2/3]  ">
              <img
                src="https://lifencolors.in/cdn/shop/files/captivating-best-seller-wallpaper.jpg?v=1706094265"
                className="object-cover h-full rounded-xl"
                alt="Your Image"
              ></img>
            </div>
            <h4 className="mt-2 ">Best Sellers</h4>
            <p className="hidden md:block text-[.75rem]">
              Explore our Best-selling wallpapers
            </p>
          </div>
          <div>
            <div className="aspect-[2/3]  ">
      ...
      <div className="mt-10 p-4 md:mx-10">
        ...
        <div className="flex overflow-auto mt-4 snap-x gap-3 md:gap-6 no-scrollbar mb-3">
          {product.map((element, index) => {
            return (
              <NavLink to={`/product/${element.slug}`}>
      ...
      <div className="m-8 md:m-16 text-center py-20 ">
        ...
        <div className="text-xl font-light ">
          ...
          Whatever your style, we have it covered- From abstract to traditional,
          modern and global.
        </div>
      </div>
